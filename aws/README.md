...
| <a name="input_ecr_enabled"></a> [ecr\_enabled](#input\_ecr\_enabled) | Specifies should terraform copy images to ECR and use it instead of `docker_<service>_image` | `bool` | `false` | no |
